package com.example.wuzp.loaderdemo.view.cursorloader2adapter;
 ...
 */
public class CursorLoader2AdapterActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    private final int PERMISSION_CALL_LOG = 0x01;
    private CursorLoader2Adapter adapter;
    ...
    public void initData() {
       ...
       getLoaderManager().initLoader(0,null,this);
        adapter = new CursorLoader2Adapter(this);
